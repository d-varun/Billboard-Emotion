...
First things first, let's take a look at our data, pulled with the `spotifyr` and `billboard` packages.
...
song_data |> 
  ...
  labs(title = "Anger in the billboard top 100 by year",
       subtitle = "Angry music has increased steadily since 1960",
       x = "Year",
       y = "Sonic Anger Index",
       caption = "Billboard and Spotify (2022)")
```
